...
import ClaimRequestModal from '@/components/query/ClaimRequestModal'
import ComplaintModal from '@/components/query/ComplaintModal'
import ItemDetailCard from '@/components/query/ItemDetailCard'
...
function QueryDetailPage() {
  ...
  const isNotFound = useMemo(() => !item, [item])
